...
/* $Id: ifftw.h,v 1.80 2002-08-09 23:26:57 athena Exp $ */
...
extern trigreal X(cos2pi)(long, unsigned long);
extern trigreal X(sin2pi)(long, unsigned long);
extern trigreal X(tan2pi)(long, unsigned long);
