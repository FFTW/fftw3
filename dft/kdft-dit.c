...
/* $Id: kdft-dit.c,v 1.11 2003-07-05 17:05:51 athena Exp $ */
...
{
     REGISTER_SOLVER(p, X(mksolver_dft_ct_directw)(codelet, desc, DECDIT));
     REGISTER_SOLVER(p, X(mksolver_dft_ct_directwbuf)(codelet, desc, DECDIT));
