 ...
 *
 *)
(* $Id: gen_twiddle.ml,v 1.4 2002-06-13 12:48:51 athena Exp $ *)

open Util
open Genutil
open C

let cvsid = "$Id: gen_twiddle.ml,v 1.4 2002-06-13 12:48:51 athena Exp $"
...
let generate n =
  ...
  and desc = 
    Printf.sprintf
      "static const ct_desc desc = { %s, twinstr, %s, 0, %s };\n\n"
