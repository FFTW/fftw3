 ...
 *
 *)
(* $Id: gen_notw.ml,v 1.1.1.1 2002-06-02 18:42:29 athena Exp $ *)

open Util
open Genutil
open C

let cvsid = "$Id: gen_notw.ml,v 1.1.1.1 2002-06-02 18:42:29 athena Exp $"
...
let generate n =
  ...
  let tree0 =
    Fcn ("static INLINE_NOTW void", name0,
